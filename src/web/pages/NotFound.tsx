  ...
  return (
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center px-6">
      <div className="max-w-[420px] w-full text-center flex flex-col items-center gap-3 bg-surface dark:bg-surface-dark border border-border dark:border-border-dark rounded-2xl p-8">
        <div className="w-14 h-14 rounded-full bg-stale/15 text-stale flex items-center justify-center">
          <span className="material-symbols-outlined text-[32px]">signpost</span>
        </div>
        <h1 className="text-[20px] font-semibold">That page doesn't exist</h1>
        <p className="text-[13px] text-text/60 dark:text-text-dark/60">The link may be old, or mistyped.</p>
        <Link
          to="/"
